...
I plan to continue exploring security frameworks and models. For instance, I want to study formal architecture frameworks (like NIST or SABSA) to see how they organize these concepts.

I also want to dive deeper into Zero Trust by looking at real-world implementations. I might follow tutorials or case studies on setting up zero-trust network access in cloud environments, to see how the theory works in practice.

Finally, I will keep practicing by doing hands-on labs. I might simulate a small company network and try applying the CIA triad and governance rules, or experiment with security tools and see how they affect usability. Writing summaries like this and reading case studies will help reinforce what I’ve learned.
